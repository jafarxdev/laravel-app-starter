    ...
    <flux:main id="main-content" class="min-w-0">
        <div class="mx-auto flex min-h-[80vh] max-w-7xl flex-col gap-6">
            <nav aria-label="Breadcrumb" class="text-sm text-zinc-500">
                @can('dashboard.view')<a href="{{ route('dashboard') }}" class="hover:text-accent focus-visible:outline-2 focus-visible:outline-accent" wire:navigate>Workspace</a><span aria-hidden="true" class="px-2">/</span>@endcan
